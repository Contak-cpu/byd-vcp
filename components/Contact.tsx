    ...
    <section id="contact" className="py-12 sm:py-16 md:py-20 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white">Contacto y Ubicación</h2>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg h-64 sm:h-80 md:h-96 lg:h-[500px] bg-gray-200 dark:bg-gray-700">
              ...
              <div className="absolute top-2 right-2 sm:top-4 sm:right-4 bg-white dark:bg-gray-800 px-2 py-1 sm:px-3 sm:py-2 rounded-lg shadow-md">
                <a 
                  ...
                  className="text-xs sm:text-sm font-medium text-primary-600 hover:text-primary-700 transition-colors flex items-center space-x-1"
                >
